...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Nov 13. 14:53
...
-- Adatbázis: `mozimusor`
--
CREATE DATABASE IF NOT EXISTS `mozimusor` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `mozimusor`;
-- --------------------------------------------------------
...
CREATE TABLE `film` (
  ...
  `filmcim` varchar(80) NOT NULL,
  `szines` tinyint(1) NOT NULL,
  `szinkron` varchar(50) NOT NULL,
...
(26, 'Dogville - A menedék', -1, 'fel', 'dán-svéd-norvég-német-finn-olasz-japán-angol-ameri', 'dráma', 177),
...
(35, 'Eros', -1, 'fel', 'amerikai-olasz-hongkongi-kínai-francia-luxemburgi-', 'dráma', 104),
...
(56, 'Hős', -1, 'mb', 'hongkongi', '', 96),
(57, 'A hősök nem pihennek', -1, '', 'francia-osztrák', 'dráma', 104),
...
(75, 'A közvetítő', -1, '', 'magyar', 'dokumentum', 89),
...
(128, 'Szőke Kóla', -1, '', 'magyar', 'vígjáték', 96),
...
(143, 'Van élet a halál előtt?', -1, '', 'magyar', 'dokumentum', 110),
...
(2, 'Bárka Kikötő a Ráday utcában', '1092', 'Ráday utca', ''),
...
(17, 'Jailhouse Club', '1094', 'IX. kerület, Tűzoltó utca 22.', '9894905'),
...
(23, 'Műcsarnok', '1406', 'Hősők tere', ''),
(24, 'Művész', '1066', 'Teréz krt. 30.', '3326726'),
(25, 'Művészetek Palotája', '1095', 'Komor Marcell u. 1.', '5553000'),
(26, 'Odeon-Lloyd mozi', '1136', 'Hollán Ernő utca 7.', '3292064'),
(27, 'Örökmozgó', '1073', 'Erzsébet krt. 39.', '3422167'),
(28, 'Palace Campona', '1222', 'Nagytétényi út 37-43.', '3458160'),
(29, 'Palace Mammut', '1024', 'Lövőház u. 2-6.', '3458160'),
...
(34, 'Sambhala Tibet Központ', '1088', 'Lőrinc pap tér 2.', '2668084'),
...
(40, 'Tűzraktár', '1094', 'Tűzoltó u. 54-56', ''),
(41, 'Uránia Nemzeti Filmszínház', '1088', 'Rákóczi út 21.', '4863413'),
(42, 'Vörösmarty', '1075', 'Üllői út 4.', '3174542');
...
CREATE TABLE `uzenetek` (
  `id` int(11) NOT NULL,
  `uzenet` varchar(80) NOT NULL,
  `felado` varchar(50) NOT NULL,
...
--
ALTER TABLE `film`
  MODIFY `fkod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT a táblához `mozi`
--
ALTER TABLE `mozi`
  MODIFY `moziazon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
